 ...
 */
contract("EACoin", function (accounts) {
  ...
  it('initializes the contract with the correct values', function() {
    return EACoin.deployed().then(function(instance) {
      ...
      assert.equal(name, 'EA Coin', 'has the correct name');
      return tokenInstance.symbol();
    }).then(function(symbol) {
      assert.equal(symbol, 'EAC', 'has the correct symbol');
      return tokenInstance.standard();
    }).then(function(standard) {
      assert.equal(standard, 'EA Coin v1.0', 'has the correct standard');
    });
  })
